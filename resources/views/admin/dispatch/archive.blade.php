<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            ...
            <a href="{{ route('admin.dispatch.export', array_merge(request()->query(), ['archive' => 1])) }}" class="rounded-md border border-slate-300 px-4 py-2 text-sm font-semibold text-slate-700 transition hover:bg-slate-100">
                CSV eksport
            </a>
        </div>
    </x-slot>
